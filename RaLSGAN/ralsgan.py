...
parser.add_argument("--epoch_interval", type=int, default=5, help="interval between image sampling")
...
for epoch in range(opt.n_epochs):
    ...
    if epoch % opt.epoch_interval == 0:
        save_image(gen_imgs.data[:25], "images/epoch %d.png" % (epoch + 1), nrow=5, normalize=True)
